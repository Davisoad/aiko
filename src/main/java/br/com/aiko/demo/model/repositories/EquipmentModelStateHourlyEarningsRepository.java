...
public interface EquipmentModelStateHourlyEarningsRepository extends PagingAndSortingRepository<EquipmentModelStateHourlyEarnings, UUID> {
    ...
    List<EquipmentModelStateHourlyEarnings> findByEquipmentModelStateHourlyEarningsIdEquipmentModelIdAndEquipmentModelStateHourlyEarningsIdEquipmentStateId(UUID equipmentModelId, UUID equipmentStateId);
}
